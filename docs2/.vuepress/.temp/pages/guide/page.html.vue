<template><p>Content before <code v-pre>more</code> comment is regarded as page excerpt.</p>
<!-- more -->
...
<ul>
<li>
<p>Please use the relative link <code v-pre>./</code> for pictures in the Markdown folder.</p>
</li>
<li>
<p>For pictures in <code v-pre>.vuepress/public</code> folder, please use absolute link <code v-pre>/</code> for reference</p>
</li>
</ul>
</div>
