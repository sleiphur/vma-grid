...
const DistributionFunctions = {
  ...
  'BETA.INV': (probability: any, alpha: any, beta: any, a: any, b: any) => {
  ...
  'BINOM.INV': (trials: any, probabilityS: any, alpha: any) => {
    trials = H.accept(trials, Types.NUMBER)
    probabilityS = H.accept(probabilityS, Types.NUMBER)
    alpha = H.accept(alpha, Types.NUMBER)
    if (
  ...
  'CHISQ.DIST': (x: any, degFreedom: any, cumulative: any) => {
    x = H.accept(x, Types.NUMBER)
  ...
  'CHISQ.DIST.RT': (x: any, degFreedom: any) => {
    x = H.accept(x, Types.NUMBER)
    degFreedom = H.accept(degFreedom, Types.NUMBER)
    degFreedom = Math.trunc(degFreedom)
    if (x < 0 || degFreedom < 1 || degFreedom > 10 ** 10) throw FormulaError.NUM
  ...
  'CHISQ.INV': (probability: any, degFreedom: any) => {
    probability = H.accept(probability, Types.NUMBER)
    degFreedom = H.accept(degFreedom, Types.NUMBER)
    degFreedom = Math.trunc(degFreedom)
    if (
  ...
  'CHISQ.INV.RT': (probability: any, degFreedom: any) => {
    probability = H.accept(probability, Types.NUMBER)
    degFreedom = H.accept(degFreedom, Types.NUMBER)
    degFreedom = Math.trunc(degFreedom)
    if (
  ...
  'CHISQ.TEST': (actualRange: any, expectedRange: any) => {
  ...
  'CONFIDENCE.NORM': (alpha: any, std: any, size: any) => {
    alpha = H.accept(alpha, Types.NUMBER)
  ...
  'CONFIDENCE.T': (alpha: any, std: any, size: any) => {
    alpha = H.accept(alpha, Types.NUMBER)
    std = H.accept(std, Types.NUMBER)
    size = H.accept(size, Types.NUMBER)
    size = Math.trunc(size)
  ...
  'COVARIANCE.P': (array1: any, array2: any) => {
    array1 = H.accept(array1, Types.ARRAY, undefined, true, true)
    array2 = H.accept(array2, Types.ARRAY, undefined, true, true)
    if (array1.length !== array2.length) throw FormulaError.NA
  ...
  'COVARIANCE.S': (array1: any, array2: any) => {
    array1 = H.accept(array1, Types.ARRAY, undefined, true, true)
    array2 = H.accept(array2, Types.ARRAY, undefined, true, true)
    if (array1.length !== array2.length) throw FormulaError.NA
  ...
  'EXPON.DIST': (x: any, lambda: any, cumulative: any) => {
    x = H.accept(x, Types.NUMBER)
  ...
  'F.DIST': (x: any, d1: any, d2: any, cumulative: any) => {
    x = H.accept(x, Types.NUMBER)
  ...
  'F.INV': (probability: any, d1: any, d2: any) => {
    // David
    probability = H.accept(probability, Types.NUMBER)
    d1 = H.accept(d1, Types.NUMBER)
    d2 = H.accept(d2, Types.NUMBER)
  ...
  'F.INV.RT': (probability: any, d1: any, d2: any) => {
    // David
    probability = H.accept(probability, Types.NUMBER)
    d1 = H.accept(d1, Types.NUMBER)
    d2 = H.accept(d2, Types.NUMBER)
  ...
  // FIXME
  FORECAST: (x: any, knownYs: any, knownXs: any) => {
    x = H.accept(x, Types.NUMBER)
  ...
  'FORECAST.LINEAR': (x: any, knownYs: any, knownXs: any) =>
    DistributionFunctions.FORECAST(x, knownYs, knownXs),

  FREQUENCY: (dataArray: any, binsArray: any) => {
  ...
  'GAMMA.DIST': (x: any, alpha: any, beta: any, cumulative: any) => {
    // David
  ...
  'GAMMA.INV': (probability: any, alpha: any, beta: any) => {
    // David
  ...
  GROWTH: (knownY: any, knownX: any, newX: any, useConst: any) => {
  ...
  'HYPGEOM.DIST': (
    ...
    function pdf(x: any, n: any, M: any, N: any) {
      return (
    ...
    function cdf(x: any, n: any, M: any, N: any) {
      let result = 0
      for (let i = 0; i <= x; i++) {
        result += pdf(i, n, M, N)
      }
  ...
  INTERCEPT: (knownYs: any, knownXs: any) => {
    // similar to FORECAST
    knownYs = H.accept(knownYs, Types.ARRAY, undefined, true, true)
    knownXs = H.accept(knownXs, Types.ARRAY, undefined, true, true)
  ...
  'LOGNORM.DIST': (x: any, mean: any, standard_dev: any, cumulative: any) => {
  ...
  'LOGNORM.INV': (probability: any, mean: any, standard_dev: any) => {
  ...
  'NORM.DIST': (x: any, mean: any, standard_dev: any, cumulative: any) => {
  ...
  'NORM.INV': (probability: any, mean: any, standard_dev: any) => {
  ...
  'NORM.S.DIST': (z: any, cumulative: any) => {
  ...
  'POISSON.DIST': (x: any, mean: any, cumulative: any) => {
  ...
  STANDARDIZE: (x: any, mean: any, standard_dev: any) => {
    x = H.accept(x, Types.NUMBER)
    mean = H.accept(mean, Types.NUMBER)
    standard_dev = H.accept(standard_dev, Types.NUMBER)
  ...
  'T.DIST': (x: any, deg_freedom: any, cumulative: any) => {
  ...
  'T.DIST.2T': (x: any, deg_freedom: any) => {
  ...
  'T.DIST.RT': (x: any, deg_freedom: any) => {
  ...
  'T.INV': (probability: any, deg_freedom: any) => {
  ...
  'T.INV.2T': (probability: any, deg_freedom: any) => {
  ...
  'WEIBULL.DIST': (x: any, alpha: any, beta: any, cumulative: any) => {
...
export default DistributionFunctions
