...
class Parsing extends EmbeddedActionsParser {
  ...
  private binaryOperatorsPrecedence

  private formulaWithPercentOp: any

  private formulaWithUnaryOp: any

  private formulaWithIntersect: any

  private formulaWithRange: any

  private formula: any

  private referenceWithoutInfix: any
  ...
  private constantArray: any

  public formulaWithBinaryOp: any

  private constantForArray: any

  private plusMinusOp: any

  private arguments: any

  private referenceItem: any

  private prefixName: any
   ...
   * @param {Utils} utils
   */
  constructor(context: any, utils: any) {
    ...
    $.RULE('formulaWithBinaryOp', () => {
      ...
      $.ACTION(() => {
        ...
        for (const ops of this.binaryOperatorsPrecedence) {
          for (
            let index = 0, length = infixes.length;
            index < length;
            index++
          ) {
      ...
      $.OR([
...

        {
          ...
          ALT: () => {
            ...
            const referenceItem: any = $.SUBRULE2($.formulaWithRange)
