...
export default class LinkedList<NodeData = any> {
   ...
   */
  public findNode(
    f: TTestFunction<NodeData>,
  ): LinkedListNode<NodeData> | undefined {
  ...
  public slice(
  ...
  ): LinkedList<NodeData | Record<string | number | symbol, unknown>> {
    ...
    for (
      let i = 0;
      i < finish - start && head !== null && head !== undefined;
      i++
    ) {
