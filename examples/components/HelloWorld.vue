...
export default defineComponent({
  ...
  setup() {
    ...
    const tableTypeGridData = [
      [2011112000, 100, 21, null, undefined, 2, '1000', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1) `, '男/女', '张三0 ', ''],
      [2011112001, 101, 21, null, undefined, 2, '1001', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1) `, '男/女', '张三1 ', ''],
      [2011112002, 102, 21, null, undefined, 2, '1002', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1) `, '男/女', '张三2 ', ''],
      [2011112003, 103, 21, null, undefined, 2, '1003', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1) `, '男/女', '张三3 ', ''],
      [2011112004, 104, 21, null, undefined, 2, '1004', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1) `, '男/女', '张三4 ', ''],
      [2011112005, 105, 21, null, undefined, 2, '1005', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1) `, '男/女', '张三5 ', ''],
      [2011112006, 106, 21, null, undefined, 2, '1006', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1) `, '男/女', '张三6 ', ''],
      [2011112007, 107, 21, null, undefined, 2, '1007', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1) `, '男/女', '张三7 ', ''],
      [2011112008, 108, 21, null, undefined, 2, '1008', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1) `, '男/女', '张三8 ', ''],
      [2011112009, 109, 21, null, undefined, 2, '1009', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三9 ', ''],
      [2011112010, 110, 21, null, undefined, 2, '1010', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三10', ''],
      [2011112011, 111, 21, null, undefined, 2, '1011', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三11', ''],
      [2011112012, 112, 21, null, undefined, 2, '1012', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三12', ''],
      [2011112013, 113, 21, null, undefined, 2, '1013', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三13', ''],
      [2011112014, 114, 21, null, undefined, 2, '1014', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三14', ''],
      [2011112015, 115, 21, null, undefined, 2, '1015', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三15', ''],
      [2011112016, 116, 21, null, undefined, 2, '1016', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三16', ''],
      [2011112017, 117, 21, null, undefined, 2, '1017', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三17', ''],
      [2011112018, 118, 21, null, undefined, 2, '1018', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三18', ''],
      [2011112019, 119, 21, null, undefined, 2, '1019', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三19', ''],
      [2011112020, 120, 21, null, undefined, 2, '1020', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三20', ''],
      [2011112021, 121, 21, null, undefined, 2, '1021', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三21', ''],
      [2011112022, 122, 21, null, undefined, 2, '1022', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三22', ''],
      [2011112023, 123, 21, null, undefined, 2, '1023', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三23', ''],
      [2011112024, 124, 21, null, undefined, 2, '1024', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三24', ''],
      [2011112025, 125, 21, null, undefined, 2, '1025', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三25', ''],
      [2011112026, 126, 21, null, undefined, 2, '1026', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三26', ''],
      [2011112027, 127, 21, null, undefined, 2, '1027', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三27', ''],
      [2011112028, 128, 21, null, undefined, 2, '1028', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三28', ''],
      [2011112029, 129, 21, null, undefined, 2, '1029', '测试数据', `=SUM(${getNextColumnIndex(1)}1, ${getNextColumnIndex(2)}1)`, '男/女', '张三29', ''],
    ]
